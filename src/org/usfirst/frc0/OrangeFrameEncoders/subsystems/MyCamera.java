...
public class MyCamera extends Subsystem {
    ...
    int m_hueLow = 80;
    int m_hueHigh = 140;
    int m_saturationLow = 20;
    int m_saturationHigh = 255;
    int m_valueLow = 20;
    int m_valueHigh = 175;
    ...
    public void GetCameraInfo() {
        ...
        m_hueLow = (int)SmartDashboard.getNumber("Hue Low");
        m_hueHigh = (int)SmartDashboard.getNumber("Hue High");
        m_saturationLow = (int)SmartDashboard.getNumber("Saturation Low");
        m_saturationHigh = (int)SmartDashboard.getNumber("Saturation High");
        m_valueLow = (int)SmartDashboard.getNumber("Value Low");
        m_valueHigh = (int)SmartDashboard.getNumber("Value High");
        ...
        try {
            ...
            System.out.println("m_hueLow = " + m_hueLow + "\r\n" +
                               "m_hueHigh = " + m_hueHigh + "\r\n" +
                               "m_saturationLow = " + m_saturationLow + "\r\n" +
                               "m_saturationHigh = " + m_saturationHigh + "\r\n" +
                               "m_valueLow = " + m_valueLow + "\r\n" +
                               "m_valueHigh = " + m_valueHigh + "\r\n");
                //ColorImage image;                           // next 2 lines read image from flash on cRIO
            //image = new RGBImage("/testImage.jpg");		// get the sample image from the cRIO flash
            BinaryImage thresholdImage = image.thresholdHSV(m_hueLow,
                                                            m_hueHigh, 
                                                            m_saturationLow, 
                                                            m_saturationHigh, 
                                                            m_valueLow, 
                                                            m_valueHigh);   // keep only green objects
            ...
            if (filteredImage.getNumberParticles() > 0) {
                ...
                if (verticalTargetCount > 0) {
                    ...
                    if (target.Hot) {
                        ...
                        hotTarget = true;
                        hotSince = System.currentTimeMillis();
